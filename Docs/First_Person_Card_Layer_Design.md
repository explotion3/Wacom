...
| `06 Transition Motion` | Drawn / Gained / HandAnchorEntered / Played / Discarded 事件转场方向、来源和入场 timing |
...
- Drawn / Gained / HandAnchorEntered / Played / Discarded transition hint 只改变表现来源或离场方向，不改变 snapshot 真相、命令路径或 slot key。
