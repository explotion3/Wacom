...
- 敌人行动已具备 Journal 前后 Combat facts、Clip Impact marker、严格 Impact → Complete barrier 和 PlayerStatusBar 被动脉冲。剩余表现债是 HP/Shield 平滑插值、屏幕闪红、镜头震动、受击方向与正式音频资产；这些能力应继续消费同一 Impact 语义，不得重新从最终 Snapshot、事件名称或动画时间猜命中。
