...
- [ ] **交互目标系统：Card-World / Card-Card drag resolver / Zone 命中来源接入**
  - 状态：`Done: V0-BY 已给 AWacomRunKeyChestActor 接入 UWacomRunKeyChestDefinition 数据驱动配置，并由 commandlet 生成 DebugKeyGold3 样例资产；后续正式内容、动画、SaveGame、复杂筛选和多奖励仍待切片`
  - 归属：App / Battle
