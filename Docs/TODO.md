...
- [ ] **交互目标系统：Card-World / Card-Card drag resolver / Zone 命中来源接入**
  - 状态：`Done: V0-BX 已给 AWacomRunKeyChestActor 增加 placement validation 和 receiver 诊断；后续正式宝箱数据、动画、SaveGame、复杂筛选仍待切片`
  - 归属：App / Battle
