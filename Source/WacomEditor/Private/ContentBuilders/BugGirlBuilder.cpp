...
namespace
{
	...
	TArray<UCardDefinition*> BuildBugGirlStarterPackCards()
	{
		...
		Cards.Add(BuildCard(
			...
			ECardTargetMode::SingleEnemyPart,
			FCardPhysique{},
			/*Effects*/ { RemoveEnemyStatus(WacomTags::Status_Freeze, 1), ModifyEnemyInitiative(-2) },
			/*PerfectRelease*/ {},
			/*ZoneHooks*/ {},
			/*Passives*/ {}
		));
	...
	TArray<UCardDefinition*> BuildBugGirlBadgeDisplayTestCards()
	{
		...
		Cards.Add(BuildCard(
			...
			TEXT("徽章伤毒测试"),
			TEXT("测试卡面徽章：造成 {Effect.0} 伤害并施加 {Effect.1} 中毒。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ { WacomTags::Card_Keyword_Tool },
			ECardTargetMode::SingleEnemyPart,
		...
		Cards.Add(BuildCard(
			...
			TEXT("徽章盾疗测试"),
			TEXT("测试卡面徽章：获得 {Effect.0} 护盾并恢复 {Effect.1} 生命。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ { WacomTags::Card_Keyword_Tool },
			ECardTargetMode::None,
		...
		Cards.Add(BuildCard(
			...
			TEXT("徽章伤盾疗测试"),
			TEXT("测试卡面徽章：造成 {Effect.0} 伤害，获得 {Effect.1} 护盾，恢复 {Effect.2} 生命。"),
			/*BaseCost*/ 1,
			WacomTags::Card_Rarity_Blue,
			/*Keywords*/ { WacomTags::Card_Keyword_Tool },
			ECardTargetMode::SingleEnemyPart,
		...
		Cards.Add(BuildCard(
			...
			TEXT("徽章四项测试"),
			TEXT("测试卡面徽章：造成 {Effect.0} 伤害，施加 {Effect.1} 中毒，获得 {Effect.2} 护盾，恢复 {Effect.3} 生命。灼烧徽章仅有美术位，规则未接入。"),
			/*BaseCost*/ 2,
			WacomTags::Card_Rarity_Blue,
			/*Keywords*/ { WacomTags::Card_Keyword_Tool },
			ECardTargetMode::SingleEnemyPart,
...
namespace Wacom::ContentBuilder
{
	UCharacterDefinition* BuildBugGirlContent()
	{
		...
		UCardDefinition* TestAddCostToSelectedHand = BuildCard(
			...
			TEXT("加费测试"),
			TEXT("测试卡：拖到另一张手牌上，使目标卡费用增加 {Effect.0}。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ {},
		...
		UCardDefinition* TestReduceCostToSelectedHand = BuildCard(
			...
			TEXT("减费测试"),
			TEXT("测试卡：拖到另一张手牌上，使目标卡费用降低 {Effect.0}。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ {},
			ECardTargetMode::HandCard,
		...
		UCardDefinition* TestRequireCompanionTarget = BuildCard(
			...
			TEXT("只作用伙伴测试"),
			TEXT("测试卡：只能拖到带伙伴关键词的手牌上，使目标卡费用增加 {Effect.0}。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ {},
			ECardTargetMode::HandCard,
		...
		UCardDefinition* TestBlockWeaponTarget = BuildCard(
			...
			TEXT("不能作用武器测试"),
			TEXT("测试卡：不能拖到带武器关键词的手牌上，其他合法手牌目标费用增加 {Effect.0}。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ {},
			ECardTargetMode::HandCard,
		...
		UCardDefinition* TestDiscardSelectedHandCard = BuildCard(
			...
			TEXT("弃置目标手牌测试"),
			TEXT("测试卡：拖到另一张普通手牌上，{Effect.0}目标卡并使其进入弃牌堆。不能选择左右手。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ {},
			ECardTargetMode::HandCard,
		...
		UCardDefinition* TestExhaustSelectedHandCard = BuildCard(
			...
			TEXT("消耗目标手牌测试"),
			TEXT("测试卡：拖到另一张普通手牌上，{Effect.0}目标卡并使其进入消耗牌堆。不能选择左右手。"),
			/*BaseCost*/ 0,
			WacomTags::Card_Rarity_White,
			/*Keywords*/ {},
			ECardTargetMode::HandCard,
