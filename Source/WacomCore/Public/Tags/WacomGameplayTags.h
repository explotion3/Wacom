...
namespace WacomTags
{
	...
	// -------- Run.Card.Action --------
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action);
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action_Reveal);
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action_Unlock);
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action_Break);
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action_Fix);
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action_Ignite);
	WACOMCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Run_Card_Action_Feed);
