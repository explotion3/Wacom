...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wacom|Battle|Presentation Stack|Authoring", meta = (ToolTip = "表现栈小卡使用的只读卡面 Widget。为空时优先加载 WBP_CardView，最后回退 UWacomCardView。第一人称手牌专用的 WBP_FPCardView 不作为表现栈默认值。"))
