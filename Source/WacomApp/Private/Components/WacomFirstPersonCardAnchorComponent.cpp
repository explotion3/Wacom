...
struct FWacomFirstPersonCardPresentationScaleBridge
{
		...
		FWacomFirstPersonCardResolvedLayoutConfig& Config)
	{
		...
		Config.InvalidTargetPreviewTightenPixels *= Scale;
		...
		Config.DenyFeedbackCrackLengthPixels *= Scale;
		Config.DenyFeedbackCrackThicknessPixels *= Scale;
...
namespace
{
		...
		FWacomFirstPersonCardResolvedLayoutConfig& Config)
	{
		...
		Config.bEnableInvalidTargetPreview = Anchor.bEnableInvalidTargetPreview;
		Config.InvalidTargetPreviewEnterDuration = Anchor.InvalidTargetPreviewEnterDuration;
		Config.InvalidTargetPreviewExitDuration = Anchor.InvalidTargetPreviewExitDuration;
		Config.InvalidTargetPreviewColor = Anchor.InvalidTargetPreviewColor;
		Config.InvalidTargetPreviewAccentColor = Anchor.InvalidTargetPreviewAccentColor;
		Config.InvalidTargetPreviewOpacity = Anchor.InvalidTargetPreviewOpacity;
		Config.InvalidTargetPreviewTightenPixels = Anchor.InvalidTargetPreviewTightenPixels;
		Config.DenyFeedbackDuration = Anchor.DenyFeedbackDuration;
		Config.DenyFeedbackShakePixels = Anchor.DenyFeedbackShakePixels;
		Config.DenyFeedbackCompressScale = Anchor.DenyFeedbackCompressScale;
		Config.DenyFeedbackColor = Anchor.DenyFeedbackColor;
		Config.DenyFeedbackAccentColor = Anchor.DenyFeedbackAccentColor;
		...
		Config.DenyFeedbackCrackLengthPixels = Anchor.DenyFeedbackCrackLengthPixels;
		Config.DenyFeedbackCrackThicknessPixels = Anchor.DenyFeedbackCrackThicknessPixels;
		Config.DenySound = Anchor.DenySound;
		Config.DenySoundVolumeMultiplier = Anchor.DenySoundVolumeMultiplier;
		Config.DenySoundPitchMultiplier = Anchor.DenySoundPitchMultiplier;
		Config.DenySoundPitchVariation = Anchor.DenySoundPitchVariation;
		...
		const FWacomFirstPersonCardResolvedLayoutConfig& Config)
	{
		...
		FeedbackConfig.bEnableInvalidTargetPreview = Config.bEnableInvalidTargetPreview;
		FeedbackConfig.InvalidTargetPreviewEnterDuration = Config.InvalidTargetPreviewEnterDuration;
		FeedbackConfig.InvalidTargetPreviewExitDuration = Config.InvalidTargetPreviewExitDuration;
		FeedbackConfig.InvalidTargetPreviewColor = Config.InvalidTargetPreviewColor;
		FeedbackConfig.InvalidTargetPreviewAccentColor = Config.InvalidTargetPreviewAccentColor;
		FeedbackConfig.InvalidTargetPreviewOpacity = Config.InvalidTargetPreviewOpacity;
		FeedbackConfig.InvalidTargetPreviewTightenPixels = Config.InvalidTargetPreviewTightenPixels;
		FeedbackConfig.DenyDuration = Config.DenyFeedbackDuration;
		FeedbackConfig.DenyShakePixels = Config.DenyFeedbackShakePixels;
		FeedbackConfig.DenyCompressScale = Config.DenyFeedbackCompressScale;
		FeedbackConfig.DenyColor = Config.DenyFeedbackColor;
		FeedbackConfig.DenyAccentColor = Config.DenyFeedbackAccentColor;
		...
		FeedbackConfig.DenyCrackLengthPixels = Config.DenyFeedbackCrackLengthPixels;
		FeedbackConfig.DenyCrackThicknessPixels = Config.DenyFeedbackCrackThicknessPixels;
		FeedbackConfig.DenySound = Config.DenySound;
		FeedbackConfig.DenySoundVolumeMultiplier = Config.DenySoundVolumeMultiplier;
		FeedbackConfig.DenySoundPitchMultiplier = Config.DenySoundPitchMultiplier;
		FeedbackConfig.DenySoundPitchVariation = Config.DenySoundPitchVariation;
		...
		const FWacomFirstPersonCardResolvedLayoutConfig& Config)
	{
		...
		AddBool(Config.bEnableInvalidTargetPreview);
		AddFloat(Config.InvalidTargetPreviewEnterDuration);
		AddFloat(Config.InvalidTargetPreviewExitDuration);
		AddColor(Config.InvalidTargetPreviewColor);
		AddColor(Config.InvalidTargetPreviewAccentColor);
		AddFloat(Config.InvalidTargetPreviewOpacity);
		AddFloat(Config.InvalidTargetPreviewTightenPixels);
		AddColor(Config.DenyFeedbackColor);
		AddColor(Config.DenyFeedbackAccentColor);
		AddFloat(Config.DenyFeedbackOpacity);
		AddFloat(Config.DenyFeedbackDuration);
		AddFloat(Config.DenyFeedbackShakePixels);
		AddFloat(Config.DenyFeedbackCompressScale);
		...
		AddFloat(Config.DenyFeedbackCrackLengthPixels);
		AddFloat(Config.DenyFeedbackCrackThicknessPixels);
		Combine(GetTypeHash(Config.DenySound.Get()));
		AddFloat(Config.DenySoundVolumeMultiplier);
		AddFloat(Config.DenySoundPitchMultiplier);
		AddFloat(Config.DenySoundPitchVariation);
