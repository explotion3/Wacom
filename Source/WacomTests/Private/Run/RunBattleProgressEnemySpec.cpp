...
bool FWacomRunBattleProgressDestroyedPartKeysRestoreOnlyMatchingEnemySlotSpec::RunTest(const FString& /*Parameters*/)
{
	...
	FBattleEnemyPartKey DestroyedRightPartKey;
	{
		...
		Run->OnBattleFinishedFromTrigger(Packet, FName(TEXT("ProgressTrigger")));
	}
	...
	const bool bBuildOk = Run->BuildInitParamsForBattle(FName(TEXT("ProgressTrigger")), ReentryParams);
